...
fn sparse_ask_volume_query_is_correct() {
    ...
    book.insert_order(OrderId(2), Side::Ask, 300, 20, OrderType::Limit, None, None, &mut arena);
    book.insert_order(OrderId(3), Side::Ask, 400, 30, OrderType::Limit, None, None, &mut arena);
...
fn sparse_bid_volume_query_is_correct() {
    ...
    book.insert_order(OrderId(1), Side::Bid, 700, 10, OrderType::Limit, None, None, &mut arena);
    book.insert_order(OrderId(2), Side::Bid, 800, 20, OrderType::Limit, None, None, &mut arena);
    book.insert_order(OrderId(3), Side::Bid, 900, 30, OrderType::Limit, None, None, &mut arena);
...
fn mixed_dense_sparse_volume_query() {
    ...
    book.insert_order(OrderId(1), Side::Ask, 520, 15, OrderType::Limit, None, None, &mut arena);
    // Sparse region ask (below window)
    book.insert_order(OrderId(2), Side::Ask, 300, 25, OrderType::Limit, None, None, &mut arena);
...
fn fragmented_sparse_fok_precheck() {
    ...
    for i in 0..100 {
        book.insert_order(OrderId(i + 1), Side::Ask, 200 + i, 1, OrderType::Limit, None, None, &mut arena);
    }
